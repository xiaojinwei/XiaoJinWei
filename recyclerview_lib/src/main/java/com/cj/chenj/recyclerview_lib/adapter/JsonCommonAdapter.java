...
public abstract class JsonCommonAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public JsonCommonAdapter(Context context, int layoutId, JSONArray datas){
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mOnItemClickListener != null){
                    ...
                    mOnItemClickListener.onItemClick(JsonCommonAdapter.this,viewHolder,viewHolder.getConvertView(),adapterPosition,viewType);
                }
            }
        });
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        convert(holder,mDatas.optJSONObject(position),position);
    }
    ...
    public abstract void convert(ViewHolder viewHolder, JSONObject item, int position);
