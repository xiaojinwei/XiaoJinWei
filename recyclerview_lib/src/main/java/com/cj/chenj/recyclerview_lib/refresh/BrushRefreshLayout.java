...
public class BrushRefreshLayout extends RelativeLayout {
    ...
    public BrushRefreshLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BrushRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!mIsFirst) {
            ...
            boolean refreshable = findRefreshable(this);
            if(!refreshable){
...
//                        if (childViewJ instanceof Refreshable) {
//                            mRefreshable = (Refreshable) childViewJ;
//                            break over;
//                        }
//                    }
//                }
...
//
//
//                if(childView instanceof Refreshable){
//                    mRefreshable = (Refreshable) childView;
//                    break over;
//                }
//            }
            mIsFirst = true;
    ...
    private boolean findRefreshable(ViewGroup viewGroup){
        ...
        for(int i=0;i<viewGroup.getChildCount();i++){
            ...
            if(childAt instanceof Refreshable){
                mRefreshable = (Refreshable) childAt;
                return true;
            }

            if(childAt instanceof ViewGroup){
                flag = findRefreshable((ViewGroup) childAt);
            }
        }
        return flag;
    }
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (!mStart) {
                    ...
                    if (mRefreshable.canRefreshUp() && !mIsCanScoll) {
                        showRefreshArrow();
                        mStartY = (int) event.getRawY();
                        mIsCanScoll = true;
                    } else {
...
//    }
    ...
    public interface OnPullListener {
         ...
         * 加载操作
         */
        void onLoadMore(BrushRefreshLayout pullRefreshLayout);
    }
